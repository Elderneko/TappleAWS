...
public class ProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private class Tarea extends android.os.AsyncTask<Void, Teacher, Teacher> {
        ...
        protected void onPostExecute(Teacher t) {
            ...
            if(t != null){
                LinearLayout layout = findViewById(R.id.layout_profile);
                TextView tName = layout.findViewById(R.id.txt_profile_name);
                TextView tSurnames = layout.findViewById(R.id.txt_profile_surnames);
                TextView tEmail = layout.findViewById(R.id.txt_profile_email);
                TextView tBirthday = layout.findViewById(R.id.txt_profile_birthday);
